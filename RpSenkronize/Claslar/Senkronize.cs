    ...
    public class Senkronize
    {
        ...
        public void genel_toplam_bilgileri(string baslangic, string bitis)
        {
            ...
            try
            {
                ...
                dateTime2 = DateTime.ParseExact(bitis, "dd.MM.yyyy HH:mm:ss", CultureInfo.InvariantCulture).AddDays(1);
            }
            catch (Exception)
            {
            ...
            string gelen_baslangic = dateTime.ToString("yyyy-MM-dd 03:59:00");




            string gelen_bitis = dateTime2.ToString("yyyy-MM-dd 03:59:59");
